...
type GRPCWebServiceBuilder interface {
	...
	RegisterGRPCAPIs(register func(server *grpc.Server)) GRPCWebServiceBuilder
...
type RESTBuilder interface {
	...
	AddGRPCGatewayHandlers(handlers ...func(mux *runtime.ServeMux, endpoint string) error) RESTBuilder
